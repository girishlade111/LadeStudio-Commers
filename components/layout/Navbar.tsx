            ...
            <nav className="relative z-10 flex items-center justify-between gap-3 px-3 py-2 sm:px-5 sm:py-2.5 lg:px-6">
              ...
              <div className="flex items-center gap-1 sm:gap-1.5">
                <button
                  ...
                  className={`hidden sm:flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg transition-all duration-300 ${
                    isScrolled 
                ...
                <Link
                  href="/wishlist"
                  className={`relative flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-lg transition-all duration-300 ${
                    isScrolled 
                      ? 'text-neutral-500 hover:text-secondary hover:bg-secondary/5' 
                      : 'text-white/60 hover:text-white hover:bg-white/10'
                  }`}
